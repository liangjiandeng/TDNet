...
def load_set(file_path):
    ...
    return lms, ms, pan
#ckpt = "ablation_study/without_mra390.pth"#bdpn_mra11
...
def test(file_path):
    ...
    with torch.no_grad():
       ...
       # tensor type: CxHxW
        ...
        print(sr.shape)
        save_name = os.path.join("results", "wv2_new_data5_our.mat")
        sio.savemat(save_name, {'wv2_new_data5_our': sr})


if __name__ == '__main__':
    file_path = "test_data/WV2_Simu/new_data5_wv2.mat"
    test(file_path)
